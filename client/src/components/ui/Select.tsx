    ...
    return (
        <div className={`w-full flex flex-col gap-2 ${containerClassName}`}>
            ...
            <div className="relative group">
                {icon && (
                    <div className="absolute inset-y-0 left-4 flex items-center text-brand-muted group-focus-within:text-brand-primary transition-colors z-10">
                        {icon}
                    </div>
                )}
                ...
                <select
                    ...
                    className={`
                        ...
                        border-2 ${error ? "border-brand-primary" : "border-brand-border"} border-b-4 
            ...
            {error && (
                <span className="text-[10px] text-brand-primary font-black ml-2 uppercase tracking-wide">
                    {error}
                </span>
            )}
        </div>
