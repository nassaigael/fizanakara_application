    ...
    return (
        <div 
            ...
            className={`
                ...
                bg-linear-to-r from-red-50 via-orange-50 to-white 
        ...
        >
            ...
            <div className="w-full sm:w-auto text-left sm:text-right bg-linear-to-br from-red-100 to-orange-100 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl border-2 border-red-200">
