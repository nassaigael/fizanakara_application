...
const MemberDetailModal: React.FC<MemberDetailModalProps> = ({ member, onClose, onEdit }) => {
  return createPortal(
        ...
        <div className="p-8 pt-16">
          ...
          <div className="bg-gray-50 p-4 rounded-3xl border-2 border-gray-100 space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-black text-xs">{member.status === 'WORKER' ? 'Travailleur' : 'Étudiant'}</span>
            </div>
            <div className="flex justify-between">
