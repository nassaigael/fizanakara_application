                                            ...
                                            <div key={contribution.id} className="border border-gray-200 rounded-xl overflow-hidden">
                                                ...
                                                <div className="p-3 bg-white">
                                                    ...
                                                    <div className="flex justify-between items-center mb-3 pb-2 border-b border-gray-100">
                                                        <span className="text-[9px] font-black text-gray-500 uppercase">Remaining to Pay</span>
                                                        <span className={`font-black text-sm ${isPaid ? 'text-green-600' : 'text-red-600'}`}>
                                                            {formatCurrency(contribution.remaining)}
                                                        </span>
                                                    </div>
                                                    
                                                    {/* Barre de progression du paiement */}
                                                    <div className="mt-2">
                                                        <div className="flex justify-between text-[7px] font-black text-gray-400 mb-1">
                                                        ...
                                                        <div className="w-full h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                                            <div 
                                                                className={`h-full rounded-full ${
                                                                    isPaid ? 'bg-green-500' : isPartial ? 'bg-orange-500' : 'bg-red-500'
                                                                }`}
                                                    ...
                                                    {contribution.payments && contribution.payments.length > 0 && (
                                                        <div className="mt-3 pt-3 border-t border-gray-100">
                                                            <p className="text-[8px] font-black text-gray-400 uppercase mb-2">Payment Details</p>
