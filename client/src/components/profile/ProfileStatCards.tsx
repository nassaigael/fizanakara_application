...
const ProfileStatCards: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className="bg-white border-2 border-gray-200 rounded-2xl p-4 shadow-[0_6px_0_0_#E5E5E5] hover:shadow-[0_8px_0_0_#E5E5E5] hover:-translate-y-0.5 transition-all duration-300">
